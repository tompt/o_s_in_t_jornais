		...
		<section id="dashboard">
			...
			<!-- Nav atalhos -->
				...
				<ul class="shortcuts">
					...
					<li class="shortcut-tickets"><a href="osint_jornais.php" title="">OSINT-Jornal Económico</a></li>
					<li class="shortcut-tickets"><a href="osint_capas.php" title="">OSINT-Capas Jornais</a></li>
					<li class="shortcut-tickets"><a href="osint_Secnewspaper.php" title="">OSINT-Sec newspaper</a></li>
				</ul>
					<!-- fim teste-->
			<!-- /Nav atalhos -->
		</section>
